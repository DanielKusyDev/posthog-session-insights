...
```bash
   git clone https://github.com/DanielKusyDev/posthog-session-insights
...
- generate react website to capture initial posthog events
- interpret the task
- generate tests cases and dummy client script
